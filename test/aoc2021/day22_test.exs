defmodule Aoc2021.Day22Test do
  ...
  test "solves part1 for provided example" do
    assert 590_784 == Day22.part1(small_example_input())
  end
  ...
  test "ranges intersection" do
    assert 2..4 == Day22.range_intersection(1..4, 2..6)
    assert 2..4 == Day22.range_intersection(2..6, 1..4)
    assert 2..4 == Day22.range_intersection(0..6, 2..4)
    assert nil == Day22.range_intersection(1..2, 3..4)
  end

  test "cubes on after init procedure" do
    assert 2 ** 3 == Day22.cubes_on_after_init_procedure([{1, [1..2, 1..2, 1..2]}])

    assert 1000 - 2 ** 3 ==
             Day22.cubes_on_after_init_procedure([
               {1, [1..10, 1..10, 1..10]},
               {0, [9..11, 9..11, 9..11]}
             ])
